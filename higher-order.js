...
let totalPopulation = populations.reduce((acur, curr) => acur + curr)
...
let ordersTotal = orders.map((e) => e.price * (1 + e.tax))// Your code here
...
console.log(findBob);
let bobsTotal = findBob.reduce((acum, curr) => { return acum + curr.price}, 0)

// let bobsTotal = purchases.reduce((acum, cur) => {if(cur.owner === "Bob"){return acum + cur.price}}, 0)
