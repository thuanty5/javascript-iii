...
var oneManager = new Manager("fname", "lname", "email", 10)

// console.log(oneManager);
...
class ProgressiveManager extends Manager{
    ...
    updateTitle(){
        // var reportLen1 = this.reports.length;
        // var title1 = this.title;
        if(this.reports.length === 0){
            this.title = "Note a manager";
...
var oneProMan = new ProgressiveManager("fname", "lname", "email", 12);

// console.log(oneProMan);
